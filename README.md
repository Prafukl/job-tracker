...
erDiagram
    ...
    USER ||--o{ APPLICATION : "creates and manages"
    USER ||--o{ NOTE : "writes and organizes"
    USER ||--o{ TUTORIAL : "watches and uploads"
    APPLICATION }o--|| COMPANY : "applied to"
    USER ||--o{ KNOWLEDGE_TOOL : "accesses and uses"
